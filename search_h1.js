...
async function searchProduct(term) {
    ...
    try {
        ...
        for (const p of list) {
            ...
            // Check if "3500" is in description if user asked for it
            if (desc.includes('3500') || ref.includes('3500')) {
                console.log(`MATCH 3500: [${cod}] ${desc} (Ref: ${ref})`);
            } else {
...
// Hardcode search for "H1" to get all H1s and check for 3500
searchProduct("H1");
